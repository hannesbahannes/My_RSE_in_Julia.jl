...
open(joinpath(@__DIR__, "src", "license.md"), "w") do io
	...
	println(
		...
		"""
```@meta
EditURL = "https://github.com/hannesbahannes/My_RSE_in_Julia.jl/blob/main/LICENSE.md"
```
""",
	)
...
makedocs(modules = [TrapezoidalRule],
	...
	format = Documenter.HTML(prettyurls = get(ENV, "CI", nothing) == "true",
		canonical = "https://hannesbahannes.github.io/My_RSE_in_Julia.jl/stable"),
...
deploydocs(repo = "github.com/hannesbahannes/My_RSE_in_Julia.jl",
	devbranch = "main",
	push_preview = true)
